...
const HeaderProfile = ({isSelected, handleSetIsSelected}) => {
    return(
        <button name={isSelected ? "menu" : "close"} onClick={()=>{handleSetIsSelected()}} className="text-[30px] cursor-pointer md:hidden">
